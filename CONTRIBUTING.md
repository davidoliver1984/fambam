...
| `docs/ENGINEERING_METHODOLOGY.md` | The engineering process, roles and lifecycle used within Fambam |
...
| `ENGINEERING_GUIDELINES.md` | Project-specific review and implementation boundaries |
...
All contributors should follow this methodology before making
...
Project-specific architectural-review and implementation boundaries are defined in `ENGINEERING_GUIDELINES.md` and does not relax any rule in this
section.
...
## Implementation evidence and engineering retrospectives
