...
- `ENGINEERING_GUIDELINES.md` — engineering collaboration guidance without duplicating authoritative documents.
...
- Treat automatically generated code and documentation as drafts requiring repository-aware review.
...
roadmap convention already established and documented by Fambam. `phase-n` is the roadmap phase number (`PROJECT_ROADMAP.md`'s
