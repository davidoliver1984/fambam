...
reconciliation against the implementation-blocker review, run before
...
- **Leaving Event creation/editing authority and `primary_event_id`
  ...
  resource; leaving them unstated would leave an implementation ambiguity this
...
- Making Event-invitation acceptance deterministic under any membership
  ...
  unspecified race the implementer would otherwise have had to guess about.
