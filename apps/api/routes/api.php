...
use App\Http\Controllers\FamilyExportController;
...
Route::middleware(['auth:sanctum', 'database-context'])->group(function (): void {
    ...
    Route::prefix('/families/{familySpace}')->middleware('family-space')->group(function (): void {
        ...
        Route::get('/exports', [FamilyExportController::class, 'index']);
        Route::post('/exports/full', [FamilyExportController::class, 'storeFull']);
        Route::post('/exports/personal', [FamilyExportController::class, 'storePersonal']);
        Route::get('/exports/{familyExport}', [FamilyExportController::class, 'show']);
        Route::get('/exports/{familyExport}/download', [FamilyExportController::class, 'download']);
        ...
        Route::post('/face-identity-assignments/{assignment}/reject', [FaceIdentityAssignmentController::class, 'reject']);
        Route::get('/face-identity-suppressions', [FaceIdentitySuppressionController::class, 'index']);
        Route::post('/face-identity-suppressions/{suppression}/reopen', [FaceIdentitySuppressionController::class, 'reopen']);
        Route::get('/face-clusters', [FaceClusterController::class, 'index']);
        Route::post('/face-clusters/merge', [FaceClusterController::class, 'merge']);
        Route::post('/face-clusters/{cluster}/name', [FaceClusterController::class, 'name']);
        Route::post('/face-clusters/{cluster}/split', [FaceClusterController::class, 'split']);
        ...
        Route::get('/photos/{photo}/edit-previews/{preview}/delivery', [PhotoEditorController::class, 'previewDelivery']);
        Route::post('/photos/{photo}/edit-previews/{preview}/apply', [PhotoEditorController::class, 'apply']);
        Route::delete('/photos/{photo}/edit-previews/{preview}', [PhotoEditorController::class, 'discard']);
        Route::put('/photos/{photo}/active-version', [PhotoEditorController::class, 'activate']);
        Route::get('/photos/{photo}/versions/{version}/delivery', [PhotoEditorController::class, 'versionDelivery']);
        ...
        Route::put('/photos/{photo}/reaction', [PhotoConversationController::class, 'react']);
        Route::delete('/photos/{photo}/reaction', [PhotoConversationController::class, 'removeReaction']);
