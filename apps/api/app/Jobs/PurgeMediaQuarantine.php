...
class PurgeMediaQuarantine implements ShouldBeUnique, ShouldQueue
{
    ...
    {
        return "media-quarantine:{$this->mediaUploadId}";
    }

    public function handle(MediaQuarantineRetentionManager $retention): void
    {
        ...
        $span = Globals::tracerProvider()
            ...
            ->spanBuilder('media-upload.quarantine-purge')
        ...
        try {
            $retention->purge($context, $this->mediaUploadId);
        } finally {
