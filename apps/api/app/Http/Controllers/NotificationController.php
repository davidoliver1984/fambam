...
class NotificationController extends Controller
{
    ...
    {
        $data = $request->validate(['preferences' => 'required|array|max:8', 'preferences.*.category' => ['required', Rule::enum(NotificationCategory::class)], 'preferences.*.channel' => ['required', Rule::enum(NotificationChannel::class)], 'preferences.*.enabled' => 'required|boolean']);
